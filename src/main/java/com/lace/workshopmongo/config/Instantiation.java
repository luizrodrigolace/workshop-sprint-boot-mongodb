package com.lace.workshopmongo.config;
...
import com.lace.workshopmongo.dto.AuthorDTO;
import com.lace.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu viagem", "Viajar para São Paulo. Abraços", new AuthorDTO(maria));
